...
/**
 * Cursor component. Applies the raycaster2 component specifically for starting the raycaster2
 * from the camera and pointing from camera's facing direction, and then only returning the
 * closest intersection. Cursor can be fine-tuned by setting raycaster2 properties.
 *
 ...
 */
AFRAME.registerComponent('cursor2', {
  dependencies: ['raycaster2'],
  ...
  updateMouseEventListeners: function () {
    ...
    canvas.removeEventListener('mousemove', this.onMouseMove);
    canvas.removeEventListener('touchmove', this.onMouseMove);
    el.setAttribute('raycaster2', 'useWorldCoordinates', false);
    if (this.data.rayOrigin !== 'mouse') { return; }
    canvas.addEventListener('mousemove', this.onMouseMove, false);
    canvas.addEventListener('touchmove', this.onMouseMove, false);
    el.setAttribute('raycaster2', 'useWorldCoordinates', true);
  ...
  onMouseMove: (function () {
    ...
    return function (evt) {
      ...
      this.el.setAttribute('raycaster2', rayCasterConfig);
  ...
  onCursorDown: function (evt) {
    ...
    if (this.data.rayOrigin === 'mouse' && evt.type === 'touchstart') {
      ...
      this.el.components.raycaster2.checkIntersections();
      evt.preventDefault();
    }
  ...
  onIntersection: function (evt) {
    ...
    if (this.intersectedEl) {
      currentIntersection = this.el.components.raycaster2.getIntersection(this.intersectedEl);
  ...
  clearCurrentIntersection: function (ignoreRemaining) {
    ...
    intersections = this.el.components.raycaster2.intersections;
  ...
  twoWayEmit: function (evtName) {
    ...
    intersection = this.el.components.raycaster2.getIntersection(intersectedEl);
